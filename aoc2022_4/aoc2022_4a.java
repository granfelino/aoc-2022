...
class aoc2022_4a {
    public static int getContainsCount(BufferedReader br) throws IOException{
        ...
        while(line != null) {
            ...
            boolean firstInSecond = (fields[0] >= fields[2]) && (fields[1] <= fields[3]);
            boolean secondInFirst = (fields[2] >= fields[0]) && (fields[3] <= fields[1]); 
            if(firstInSecond || secondInFirst) { totalCount++; }
